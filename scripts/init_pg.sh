...
psql -h $DB_SERVER $DB_NAME -U $USER -w -c "\copy public.account_userproduct ( user_id, product_id, sort_order ) FROM 'data/account_userproduct.csv' delimiter ',' csv header;"
